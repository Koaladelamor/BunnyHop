...
public class CPMPlayer : MonoBehaviour
{
   ...
   \*******************************************************************************************************/
    ...
    {
        _cmd.forwardMove = Manager_Input._INPUT_MANAGER.GetLeftAxis().y;
        _cmd.rightMove = Manager_Input._INPUT_MANAGER.GetLeftAxis().x;
    }
    ...
    private void QueueJump()
    {
        if (holdJumpToBhop)
        {
            wishJump = Manager_Input._INPUT_MANAGER.GetJumpButtonDown();
            return;
        }

        if (Manager_Input._INPUT_MANAGER.GetJumpButtonDown() && !wishJump)
            wishJump = true;
